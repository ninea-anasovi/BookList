    ...
    <>
        <div className='flex rounded-[20px] px-6 bg-gradient-to-b from-slate-200'>
            <div className='-mt-10 hover:-mt-12'>
                <a  onClick={() => { setShow(!show); setBookItem({...props}) }}>
                    <img className=" rounded-lg  w-28 shadow-lg -left-4 -top-4" src={props.image} alt="image" />
                </a>
            </div>
            <div className=' w-full py-6 px-6 '>
                <a  onClick={() => { setShow(!show); setBookItem({...props}) }} data-modal-toggle="popup-modal">
                ...
                <a href={props.bookLink} target="_blank" className="inline-flex items-center text-sm font-medium text-gray-900 content-center">
                    Read more
